        ...
        <div id="home-info">
          <div className="container">
            <div className="info-content">
              <h2>Meet Bernie</h2>
              <iframe className="speeches" width="560" height="315" src="https://www.youtube.com/embed/SYxZfksAyco" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
